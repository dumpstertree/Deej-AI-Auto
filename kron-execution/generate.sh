python MP3toVec.py data mp3tovec --scan /Deej-AI-Auto/library
python Deej-A.I.py data mp3tovec --playlist /Deep-AI-Auto/output/playlist_a.m3u --nsongs 10 --lookback 10 --inputsong Deej-AI-Auto/library/test0.mp3
